...
public class LegacyEnvironmentConfiguration extends AbstractEnvironmentConfiguration
	...
	public AdjustChannel getAdjustChannelForPath(String audioPath, AssetManager assetManager) {
		if (StringUtils.isNotBlank(audioPath)) {
			Sound snd = AudioConfiguration.getSound(audioPath, assetManager);
			if (snd != null) {
				String subChannel = snd.getSubChannel();
				if (StringUtils.isNotBlank(subChannel))
					return getAdjustedChannels().get(subChannel);
				else {
					return getAdjustedChannels().get(snd.getChannel());
				}
			}
		}
		return null;
	...
	public String toString() {
		return "LegacyEnvironmentConfiguration [sun=" + sun + ", ambient=" + ambient + ", adjustedChannels="
				+ adjustedChannels + ", activateMusicDelay=" + activateMusicDelay + ", activateMusicCooldown="
				+ activateMusicCooldown + ", ambientMusicDelay=" + ambientMusicDelay + ", sky=" + sky + ", fog=" + fog
				+ ", delegate=" + delegate + ", getKey()=" + getKey() + ", getBlendTime()=" + getBlendTime()
				+ ", getDirectionalPosition()=" + getDirectionalPosition() + ", getActivateMusic()="
				+ getActivateMusic() + ", getAmbientMusic()=" + getAmbientMusic() + ", getAmbientNoise()="
				+ getAmbientNoise() + ", getAmbientSound()=" + getAmbientSound() + "]";
	}
