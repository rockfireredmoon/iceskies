		...
		if (environmentConfiguration == null) {
			...
			if (environmentConfiguration instanceof EnhancedEnvironmentConfiguration) {
				if (skyImpl == null || !(skyImpl instanceof EnhancedEnvironment)) {
					skyImpl = new EnhancedEnvironment(app, audio, camera, stateManager, assetManager, environmentLight, gameNode);
				}
				...
				if (skyImpl == null || !(skyImpl instanceof LegacyEnvironment)) {
					skyImpl = new LegacyEnvironment(app, audio, camera, stateManager, assetManager, environmentLight, gameNode);
				}
